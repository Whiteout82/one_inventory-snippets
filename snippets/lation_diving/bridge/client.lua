...
function GetItemData(item)
    ...
    if Inventory then
        ...
        elseif Inventory == 'tgiann-inventory' then
            return exports[Inventory]:GetItemList(item)
        elseif Inventory == 'jaksam_inventory' then
            return exports[Inventory]:getStaticItem(item)
        else
            -- Add custom inventory here
        end
    else
...
function HasItem(item, amount)
    ...
    if Inventory then
        if Inventory == 'one_inventory' then
            return exports.one_inventory:HasItem(item, amount)
        elseif Inventory == 'ox_inventory' then
...
function DisableInventory()
    if Inventory == 'one_inventory' then
        exports.one_inventory:SetCanOpenInventory(false)
    elseif Inventory == 'ox_inventory' then
...
function EnableInventory()
    if Inventory == 'one_inventory' then
        exports.one_inventory:SetCanOpenInventory(true)
    elseif Inventory == 'ox_inventory' then
