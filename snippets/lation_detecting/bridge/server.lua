...
function GetItemCount(source, item)
    ...
    if Inventory then
        if Inventory == 'one_inventory' then
            return exports.one_inventory:GetItemCount(source, item) or 0
...
function AddItem(source, item, count, metadata)
    ...
    if Inventory then
        if Inventory == 'one_inventory' then
            exports.one_inventory:AddItem(source, item, count, metadata)
        elseif Inventory == 'ox_inventory' then
...
function RemoveItem(source, item, count)
    ...
    if Inventory then
        if Inventory == 'one_inventory' then
            exports.one_inventory:RemoveItem(source, item, count)
        else
...
function AddMoney(source, type, amount)
    ...
    elseif Framework == 'ox' then
        if type == 'cash' or type == 'money' then
            if Inventory == 'one_inventory' then
                exports.one_inventory:AddItem(source, ConvertMoneyType(type), amount)
            else
...
function RemoveMoney(source, type, amount)
    ...
    elseif Framework == 'ox' then
        if type == 'cash' or type == 'money' then
            if Inventory == 'one_inventory' then
                exports.one_inventory:RemoveItem(source, ConvertMoneyType(type), amount)
            else
